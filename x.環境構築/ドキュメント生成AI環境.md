  ...
  - [目次](#目次)
    - [**VSCodeインストール・セットアップ**](#vscodeインストールセットアップ)
      ...
      - [２．VS Codeの日本語化](#２vs-codeの日本語化)
        - [①　拡張機能インストール画面を表示する。](#拡張機能インストール画面を表示する)
        - [②　テキストボックスに「Japanese Language Pack」を入力する。](#テキストボックスにjapanese-language-packを入力する)
        - [③　「Japanese Language Pack for Visual Studio Code」のインストールをクリックする。](#japanese-language-pack-for-visual-studio-codeのインストールをクリックする)
...
##### ①　[ダウンロードページ](https://code.visualstudio.com/)を開く。
...
##### ①　拡張機能インストール画面を表示する。
![ログイン画面](./①VSCode/日本語化/02.png)

##### ②　テキストボックスに「Japanese Language Pack」を入力する。
![ログイン画面](./①VSCode/日本語化/03.png)

##### ③　「Japanese Language Pack for Visual Studio Code」のインストールをクリックする。
