...
・Markdown Preview Enhancedのインストール完了
...
・Markdown Preview Mermaid Supportのインストール完了
...
#### ④　インストール完了
・Cline（クライン）のインストール完了
![ログイン画面](./①VSCode/Cline/07.png)

---

### <u>５．Gitのインストール</u>
・Git関連の拡張機能を順次インストールする。
...
・Git Graphのインストール完了
![ログイン画面](./①VSCode/Git/03.png)

#### ③　Git History
・Git Graphのインストールボタンをクリックしてインストールする。
![ログイン画面](./①VSCode/Git/04.png)
・Git Historyのインストール完了
...
・「完了のマーク」をクリック
![ログイン画面](./①VSCode/Git/07.png)
![ログイン画面](./①VSCode/Git/08.png)
・GitLens - Git superchargedのインストール完了
![ログイン画面](./①VSCode/Git/09.png)
...
・「Git for Windows/x64 Setup.」をクリックする。
...
・インストール先を指定する。（デフォルトでも問題ない）
![ログイン画面](./⑤VSCode_GitHub/Gitインストール/07_1.png)
![ログイン画面](./⑤VSCode_GitHub/Gitインストール/07_2.png)
...
![ログイン画面](./⑤VSCode_GitHub/Gitインストール/15_1.png)
...
#### ①　ソース管理画面から既存のリポジトリをダウンロードする。
・以下の様に「Windows用Gitのダウンロード」と表示された場合は、VSCodeを再起動する。
![ログイン画面](./⑤VSCode_GitHub/リポジトリを開く/01_1.png)
・「リポジトリをクローンする」をクリックする。
